...
uint8_t flashSel = 10;
//#define SLAVESELECT 7//ss2
//#define WIFISLAVESELECT 10//ss1
...
void Dataflash::init(uint8_t ssPin)
{
  char clr;
  ...
  digitalWrite(flashSel, HIGH); //disable device
//  pinMode(SLAVESELECT,OUTPUT);
//  digitalWrite(SLAVESELECT,HIGH); //disable device
//  pinMode(WIFISLAVESELECT,OUTPUT);
//  digitalWrite(WIFISLAVESELECT,HIGH); //disable device
  // SPCR = 01010000
